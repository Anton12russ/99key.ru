...
$this->title = 'Добавление таймера';
$this->params['breadcrumbs'][] = ['label' => 'Таймер', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => 'Добавление таймера'];
?>
...
//$this->registerJsFile('/../assest_all/timeruser/timer.min.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
//$this->registerJsFile('/../assest_all/timeruser/settings.min.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
...
$this->registerJsFile('/assest_all/timeruser/timer.min.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
$this->registerCssFile('/../assest_all/timeruser/editor.min.css', ['depends' => ['frontend\assets\AppAsset']]);
$this->registerJsFile('/assest_all/timeruser/settings.min.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
...
$this->registerJsFile('/assest_all/timeruser/editor.min.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
*/
?>
...
<script src="/../assest_all/timeruser/editor.min.js?v=1"></script>
-->
