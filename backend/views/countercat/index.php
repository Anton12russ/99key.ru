...
Всего опубликованных объявлений (<span class="rows_cat"><?= $rows?></span>)
<div class="count_start">
   <button style="width: 100%;position: relative; top: 20px; " type="button" class="btn btn-warning count_start_go"> Запустить пересчет объявлений</button>
</div>
