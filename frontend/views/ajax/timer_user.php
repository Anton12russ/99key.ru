...
'.$a_end;
	   ...
	   <script language="javascript">
            ...
            {                
                ...
                var sourcewidth = document.getElementById("timer'.$id.'").clientWidth;    
				sourcewidth = sourcewidth+30;
				// текущая ширина масштабируемого элемента
                var maxwidth = devicewidth - getOffsetLeft(document.getElementById("timer'.$id.'"))*2; // максимальная ширина масштабируемого элемента

                // масштабирование элемента 
                if (devicewidth < '.$width[1][0].' && sourcewidth > maxwidth)
                {   
var wed = maxwidth / sourcewidth;			
$("#timer'.$id.'").css("transform","scale("+wed+")");
$("#timer'.$id.'").css("transform-origin","left top");
$("#timer'.$id.'").css("width","calc(100% / "+wed+")");
$("#timer'.$id.'").css("overflow","hidden");


var hei = $("#timer'.$id.'")[0].getBoundingClientRect().height;
$("html").css("height", hei+"px");
$("html").css("overflow","hidden");
              /*   document.getElementById("timer'.$id.'").style.transform ="scale("+wed+")";
				 document.getElementById("timer'.$id.'").style.width = "calc(100% / "+wed+")";
				 document.getElementById("timer'.$id.'").style.overflow = "hidden";
				 document.getElementById("timer'.$id.'").style.transformOrigin = "left top";*/
                }       
            }
