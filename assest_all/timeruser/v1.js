(function() {
    var n = function(t, e) {
        ...
        o = {}.hasOwnProperty;
    this.flipchartCss = '<link href="/assest_all/timer/v3.css" rel="stylesheet" type="text/css">', this.MegaTimer = function() {
        var r, a, h, s;
	...
	/*if(this.params.href) {
       var  paramhref = this.params.href;
	   $('.timeradapt').wrap("<a class='oborot' target='_blank' href='"+paramhref+"'></a>");
	}
	if(this.params.adapt) {
		$('.timeradapt').addClass('adapt');
	}*/
