...
<div class="alert alert-info cachback-info" data-cach="<?=$car->price?>">Опишите пожалуйста в деталях с чем связана Ваша претензия. В течении 2-х дней она будет рассмотрена администрацией сайта и будет вынесен вердикт в отношение Вашего спора.</div>	
<?php }else{	?>	
<div class="col-md-12 row">
   <p></p>
   <span>Сумма возврата</span> <?=$model->cashback?> <i class="fa <?=RAT?>" aria-hidden="true"></i><hr style="margin: 3px;">
   <p></p>
   <p></p>
</div>
...
<div class="col-md-12 row">
	...
	<? }else{ ?>
	     <span class="time_disput">Ответ Продавца (<?=$res['date']?>)</span>
	<? } ?>
</div>	
