...
$this->title = 'Обновление таймера';
$this->params['breadcrumbs'][] = ['label' => 'Таймер', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => 'Обновление таймера'];


?>


<h2 style="display: none;" class="update"><?= Html::encode($this->title) ?></h2>
...
$this->registerJsFile('//ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
$this->registerJsFile('/../assest_all/timer/editor2.min.js?v=1', ['depends' => [\yii\web\JqueryAsset::className()]]);
/*
use yii\helpers\Url;
use yii\helpers\Html;
...
<div class="fixed-block">
    <div class="preview-block">
        ...
        <div class="switch-elements hidden" >
    ...
    <ul class="tabs-title" id="main-nav">
        <div class="tabs-title-wrap">
            ...
            <li class="active"  data-id="2" title="Подберите необходимый формат и дизайн таймера">2. Дизайн</li>
            ...
            <li class="btn btn-success" style="color: #FFF" data-id="4" title="Скопируйте код таймера и вставьте его на сайт">Сохранить</li>
...
<div class="container">
    ...
    <div class="timer-editor">
                                ...
                                <td>
                                    ...
                                    <div class="mt2">
                                        <label class="local-time no_sel">
                                            <input type="checkbox" name="types[1][usertime]" id="type-1-usertime">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="mt1 design-inputs">
                                        <label class="local-time no_sel">
                                            <input type="checkbox" name="types[3][usertime]" id="type-3-usertime">
        ...
        <!-- STEP 2 -->
        <div id="step-2" class="step" style="">
        ...
        <div id="step-3" class="step design-inputs" style="display: none;">
               ...
               <div class="ds-line clearfix">
				   ...
				   <input type="text" value="" class="link-href" style="min-width: 300px;" name="types[link]" id="type-1-date"/>
				    <!-- Адаптивность -->
