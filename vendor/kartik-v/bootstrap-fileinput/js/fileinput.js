...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tTagBef = '<div class="add-front file-preview-frame {frameClass}" id="{previewId}" data-fileindex="{fileindex}"' +
            ...
            tImage = '<img src="{data}" class="file-preview-image kv-preview-data" title="{title}" ' +
                'alt="{alt}"' + tStyle + '><div class="file-drag-handle drag-handle-init "></div>\n';
