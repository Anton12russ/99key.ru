...
$shoppar = Yii::$app->userFunctions3->shoppersonal();

$shop = $shoppar['model'];
$arr = $shoppar['count_art'];
$vote = $shoppar['vote'];
$vot = $shoppar['model']['reating'];
$phone = $shoppar['model']['field']['phone'];
...
<div class="top-menu">
  ...
  <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel"   style="right: 0; left: auto;">
     <li><a  class="loginpop login-head-class"  href="/user"><i class="fa fa-sign-in" aria-hidden="true"></i> Вход</a></li>
	 <li><a  class="loginpop login-head-class" href="/user/signup"><i class="fa fa-user-plus" aria-hidden="true"></i> Регистрация</a></li>
...
<div class="wrap">
  ...
  <div class="header-personal">
    <div class="container">
	    ...
	    <?if($shoppar['model']['img']) {?>
	       <div class="logo-personal"><a href="/"><img src="<?=Yii::getAlias('@shop_logo').'/'.$shoppar['model']['img']?>"/></a></div>
		<?}else{?>   
		...
		<div class="menutop-personal menutop-noname">
		  ...
		  <div class="row">
			...
			<div class="row">
             ...
             <div class="phone-xs hidden-md visible-xs"><i class="fa fa-phone" aria-hidden="true"></i><a style="color: #FFF;" href="tel:<?=str_replace(' ', '',$phone)?>"><?=$phone?></a></div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                     ...
                     <ul class="nav navbar-nav navbar-left">
                          ...
                          <? if($shoppar['model']['field']['price']) {?> <li> <a target="_blank" href="/uploads/images/shop/file/<?= $shoppar['model']['field']['price']?>"><i class="fa fa-pen-to-square" aria-hidden="true"></i> Прайс-Лист</a></li><?}?>
						  ...
						  <li><a href="<?=Url::to(['/payment'])?>"><i class="fa fa-money-check-dollar-pen" aria-hidden="true"></i> Оплата</a></li>
						   ...
						   <?if(isset($this->params['menu_art']) && $this->params['menu_art'] == true) {?>
...
<br>
		...
		<div class=" hidden-md visible-xs">
		   <?= Breadcrumbs::widget([
		    ...
		    <?=$this->render('/user/user_menu.php', compact('shop','arr', 'vote', 'vot', 'blocks_right'))?>
	    </div>

		<div class="<?php if (Yii::$app->user->id) { ?>col-md-9<? }else{ ?>col-md-12<? } ?>">
	  ...
	  <div class="col-md-3">
	     ...
	     <h4>Связаться с Нами</h4>
	      <ul>
			     ...
			     <li> <span>☎ <a href="tel:<?=str_replace(' ', '',$phone)?>"><?=$phone?></a></span></li>
	     </ul>	  
      </div>
	  <div class="col-md-3">
