  ...
  <div class="col-md-7 padd-h1">
   ...
   <div class="col-md-5">
	...
	<? }else{ ?>
	   ...
	   <div class="price-div">
	   <div data-toggle="tooltip" data-placement="top" title="Текущая ставка" class="one-price"> 
...
<?}?>
	...
	<? } ?>
		...
		<? if($blog->auction == 2 && $blog->reserv_user_id == Yii::$app->user->id) {?>
	<!--
    ...
    <!---->
	 ...
	 <? }else{?>
	  ...
	  <? if(iconv_strlen($blog->author['username']) >= 8) {echo 'Автор';}else{echo $blog->author['username'];}?>
		   ...
		   <div class="header-one-div one-phone col-md-8" data-phone="<?php if (isset($phone)){?><?=$phone?><? }else{  ?>Не указан<? }  ?>" data-toggle="tooltip" data-placement="top" title="Показать Телефон"><span><i class="fa fa-rocket-launch" aria-hidden="true"></i> Телефон</span></div>
	 <?}?>
  ...
  <div class="col-md-12 block-one">
   ...
   <div class="col-md-12" style="padding-top: 20px; padding-bottom: 20px;">
     <div class="row">
       ...
       <div class="ya-share2" <? if(isset($blog->imageBlog[0]['image']) && $blog->imageBlog[0]['image']) {?><?='data-image="https://1tu.ru/uploads/images/board/mini/'.$blog->imageBlog[0]['image'].'"'?> <? }?> data-curtain data-limit="7" data-services="vkontakte,odnoklassniki,skype,telegram,moimir,messenger"></div>
     </div>
   </div>
