    ...
    <div class="col-md-12 active-ads">
	  <div class="cat-board-body">
	  		<?php if ($one->status_id == 1 || $one->status_id == 2) {?>
			   ...
			   <div  class="col-md-4 col-xs-9 update"><a class="blank" data-href="<?=Url::to(['blog/update', 'id' => $one->id])?>" href="#">Редактировать</a></div>
		...
		<h3><a class="cat-bo-href" data-pjax=0 target="_blank" href="<?=$url?>"><?=Yii::$app->userFunctions->substr_user($one->title, 100)?></a></h3>
	        <div class="all_price">
	               <? $price_arr = array();
