  ...
  <div class="<? if ($block_right){?>col-lg-4 col-md-4 col-sm-4 col-xs-12<?}else{?>col-lg-3 col-md-3 col-sm-3 col-xs-12<?}?> cat-list maintree">
     <div class="el_body el-pop">
        <a  href="<?=$passurl?>">
          ...
          <div class="cat_title_width"><div class="cat_title">Попутчики <span class="cat_count">(<?=Yii::$app->userFunctions2->passangerreg(Yii::$app->request->cookies['region'])?>)</span></div> </div>
        </a>
