...
<span class="hidden balance_user" data-balance="<?=$balance?>"></span>
	    ...
	    <? if ($price_category) {?> 
         ...
         <br>
		    <a class="btn btn-success" href="https://1tu.ru/user/blogs"><i class="fa fa-list-alt" aria-hidden="true"></i> Список публикаций</a>
		 <br>
		 <br>
	    ...
	    <? }else{ ?>
		 ...
		 <div class="save"><div class="alert alert-success text-center">Объявление успешно добавлено!</div>
		 <br>
		    <a class="btn btn-success" href="https://1tu.ru/user/blogs"><i class="fa fa-list-alt" aria-hidden="true"></i> Список публикаций</a>
		 <br>
		 <br>
